...
jQuery(function ($) {
  ...
  if (Shopper.responsive) {
    ...
    $('.footer-info .block-control').click(function () {
      $('div.block-content', $(this).parent().parent()).slideToggle(300);
    ...
    $(window).resize(function () {
      ...
      if (sw > 959) {
        ...
        $('.footer-info .blck_two .block-content').show();
        $('.footer-info .blck_two .block-control').addClass('block-control-hide');

        $('.footer-info .blck_three .block-content').show();
      }
    });
  }


  var loadProductflexslider = function(){
    if ($("#product_gallery_slider").length) {
    ...
    $(window).load(function () {
        loadProductflexslider();
        if ($(".short-description").length) {
            $(".short_description_mobile").html($(".short-description").html());
        }
    });
  ...
  $('.mobile-nav .nav-container .nav-top-title').click(function () {
    $('.search-top-container').hide();
    $(this).toggleClass('over').next().toggle();
    $(".header-wrapper").height($("header").height());
    return false;
  });
  
  $('.mobile-nav .searchHeaderLabel').click(function () {
    $('#mobile-nav').hide();
    $('.search-top-container').toggle();
    $(".header-wrapper").height($("header").height());
    return false;
  });
