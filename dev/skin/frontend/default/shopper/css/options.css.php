...
/* ====================================================================== */
/* redesign*/
.navBarOption .nav-top-title, .navBarOption .nav-top-title:hover{
    border: none;
    background: #fff;
    color: #828282;
    font-size: 14px;
...
.navBarOption #mobile-nav>li{
    font-family: Arial, Helvetica, sans-serif;
    text-transform: capitalize;
    background: #ffffff;
}

.navBarOption #mobile-nav>li>a{
    font-family: Arial, Helvetica, sans-serif;
    text-transform: capitalize;
    font-weight: normal;
    color: #828282;
...
.navBarOption #mobile-nav>li:hover,
.navBarOption #mobile-nav>li.over,
.navBarOption #mobile-nav>li.active{
    background: #ffffff;
}

.navBarOption #mobile-nav>li.parent>a,
.navBarOption #mobile-nav>li.over>a,
.navBarOption #mobile-nav>li.active>a,
.navBarOption #mobile-nav>li>a:hover,
.navBarOption #mobile-nav>li>a:active{
    background: #ffffff;
}
...
@media only screen and (max-width: 959px) {
    ...
    .footer-info .block-control, .footer-info .block-control:hover{
    ...
    .footer-info .block-control.block-control-hide {
